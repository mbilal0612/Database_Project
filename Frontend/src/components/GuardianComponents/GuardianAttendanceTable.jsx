...
const rows = [
  ...
  createData(4, 'Frozen yoghurt', 1),
  createData(5, 'Gingerbread',1),
  createData(6, 'Honeycomb',1),
  createData(7, 'Ice cream sandwich',1),
  createData(8, 'Jelly Bean',1),
  createData(9, 'KitKat', 518),
  createData(10, 'Lollipop', 392 ),
  createData(11, 'Marshmallow', 1),
