...
const updatePLO = (req, res) => {
  ...
  db.query({
    ...
    timeout:40000,
    values: ["PLO", "PLO_NAME", obj.ploName, "PLO_DESC", obj.ploDesc, "PLO_ID", obj.ploID]
  },
  (error,results, fields) => {
    ...
    return res.status(200).json({message: "PLO updated successfully!"});
...
const deletePLO = (req, res) => {
    ...
    (error,results, fields) => {
      ...
      return res.status(200).json({message: "PLO deleted successfully!"});
