...
--REFERNCE COMMIT : BILAL
ALTER TABLE `QUESTION_CLO` ADD `PASSING` FLOAT NULL DEFAULT NULL AFTER `CLO_ID`;

ALTER TABLE `STD_ASMNT` ADD COLUMN `QUESTION_ID` INT NOT NULL AFTER `ASSESSMENT_ID`;